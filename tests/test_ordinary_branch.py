...
def test_ordinary_branch_json_contracts_parse() -> None:
    for path in (
        ...
        Path("configs/branch-separable-oracle.json"),
        Path("configs/uncertainty-adjudication.json"),
        Path("configs/temporal-allocation-adjudication.json"),
        Path("benchmarks/ordinary-branch-foundation-v1.json"),
        Path("benchmarks/oracle-convergence-v1.json"),
        Path("benchmarks/branch-separable-oracle-v1.json"),
        Path("benchmarks/uncertainty-adjudication-v1.json"),
        Path("benchmarks/temporal-allocation-adjudication-v1.json"),
        Path("schemas/branch-separable-oracle-record-v1.json"),
