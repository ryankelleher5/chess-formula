...
**Active milestone — fixed-budget search-efficiency curve:** hold the accepted formula fixed and compare one-ply/64-child, two-ply/128-child, three-ply/128-child, confirmed three-ply/256-child, and four-ply/256-child policies, calibrated near 100, 300, 1,000, 1,200, and 3,000 mean states. On three deterministic turns per completed confirmation game, measure depth-12 move regret, cap behavior, and wall time; also play every non-anchor point against the confirmed anchor on the completed 20-opening suite. This is development reuse only. A cheaper policy advances only if it retains at least 80% of the anchor's regret gain, stays within 10 cp mean/15 cp bootstrap-upper regret, and scores at least 47.5% with a paired lower bound of at least 40% against the anchor. Select at most one by lowest mean states and freeze a new suite before any claim.
